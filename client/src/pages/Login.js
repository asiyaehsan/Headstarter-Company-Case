  ...
  return (
    ...
    <div class="position:relative xl:w-1/2 px-10
      ...
      <div class="w-full h-100">
        <h1 class="text-8xl text-indigo-900 font-bold mb-20">Welcome Back!</h1>
        ...
        <form class="mt-6" action="#" method="POST">
          ...
          <div class="text-right mt-2">
            <a href="#" class="text-sm font-bold text-xl font-semibold text-gray-700 hover:text-indigo-500 focus:text-indigo-600">Forgot Password?</a>
          </div>
